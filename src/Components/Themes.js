...
export default function Themes () {
	return (
		<div className='Themes_Themes'>
			...
			<span className='CulturalDecorations'>Cultural Decorations</span>
			<span className='SocialDecorations'>Social Decorations</span>
			<span className='AnniversaryDecor'>Anniversary Decor</span>
			...
			<span className='TraditionalMehendidecorYellowThemedesign_4'>Traditional Mehendi decor - Yellow Theme design</span>
			<span className='TraditionalMehendidecorYellowThemedesign_5'>Traditional Mehendi decor - Yellow Theme design</span>
			<span className='TraditionalMehendidecorYellowThemedesign_6'>Traditional Mehendi decor - Yellow Theme design</span>
			...
			<Link to='/menu'>
				<img className='Vector' src = {ImgAsset.Themes_Vector} />
			</Link>
		</div>
	)
}